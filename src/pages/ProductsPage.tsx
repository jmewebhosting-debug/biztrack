    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      >
        ...
        <div className="px-6 py-4 flex justify-between items-center">
          <div>
             <h3 className="text-xl font-bold font-heading">Product Template</h3>
             <p className="text-[11px] text-text-muted">Create reusable service specs</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-8 flex flex-col gap-5 modal-form-container">
          ...
          <div className="mt-4">
            <button type="submit" className="btn-primary w-full h-14 text-base shadow-primary/40">Save Template</button>
          </div>
        </form>
      </motion.div>
    </div>
